...
We use this data to compute static "grid-to-region" coefficients that are saved as a raster file and provided with the package (`pm25_weights_rast_rfasstReg`).
